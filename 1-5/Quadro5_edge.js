...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'FUMELLO',
            type:'rect',
            rect:['112px','-226px','auto','auto','auto','auto']
         },
         {
            id:'Menu',
            type:'rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid11721", tween: [ "style", "${_Rectangle}", "-moz-transform-origin", [50,91], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,91]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid11722", tween: [ "style", "${_Rectangle}", "-ms-transform-origin", [50,91], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,91]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid11723", tween: [ "style", "${_Rectangle}", "msTransformOrigin", [50,91], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,91]}], position: 0, duration: 0, easing: "easeOutBack" },
            { id: "eid11724", tween: [ "style", "${_Rectangle}", "-o-transform-origin", [50,91], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,91]}], position: 0, duration: 0, easing: "easeOutBack" }         ]
      }
   }
},
"NUVOLA": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid11725", tween: [ "style", "${_Q5-Bird-1}", "-moz-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 0, duration: 0 },
            { id: "eid11726", tween: [ "style", "${_Q5-Bird-1}", "-ms-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 0, duration: 0 },
            { id: "eid11727", tween: [ "style", "${_Q5-Bird-1}", "msTransformOrigin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 0, duration: 0 },
            { id: "eid11728", tween: [ "style", "${_Q5-Bird-1}", "-o-transform-origin", [50,100], { valueTemplate: '@@0@@% @@1@@%', fromValue: [50,100]}], position: 0, duration: 0 },
...
"Mela-Bella-5": {
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: false,
         timeline: [
            { id: "eid11318", tween: [ "style", "${__5}", "left", '-1795.38%', { fromValue: '-1845.93%'}], position: 739, duration: 439, easing: "easeInQuad" },
            { id: "eid11319", tween: [ "style", "${__5}", "left", '-1557.18%', { fromValue: '-1795.38%'}], position: 1700, duration: 601, easing: "easeInOutQuad" },
...
"HOME_butt": {
   ...
   {
      transform: [],
      fill: ['rgba(0,0,0,0)','images/G-HOME32.png','0px','0px'],
      id: 'HOME',
      type: 'image',
...
"MENUz": {
   ...
   dom: [
   {
      ...
      fill: ['rgba(0,0,0,0)','images/G-Menu32.png','0px','0px']
   },
   {
      id: 'HOME_butt',
      type: 'rect',
   ...
   },
   {
      ...
      opacity: 1,
      type: 'image',
      fill: ['rgba(0,0,0,0)','images/svgBWNum122.svg','0px','0px']
   },
   {
      userClass: 'fumnum2',
      ...
      opacity: 1,
      type: 'image',
      fill: ['rgba(0,0,0,0)','images/svgBWNum222.svg','0px','0px']
   },
   {
      userClass: 'fumnum3',
      ...
      opacity: 1,
      type: 'image',
      fill: ['rgba(0,0,0,0)','images/svgBWNum322.svg','0px','0px']
   },
   {
      userClass: 'fumnum4',
      ...
      opacity: 1,
      type: 'image',
      fill: ['rgba(0,0,0,0)','images/svgBWNum422.svg','0px','0px']
   },
   {
      userClass: 'fumnum5',
      ...
      opacity: 1,
      type: 'image',
      fill: ['rgba(0,0,0,0)','images/svgBWNum522.svg','0px','0px']
   },
   {
      type: 'rect',
      id: 'musica',
...
"reload": {
   ...
   dom: [
   {
      ...
      rect: ['0px','0px','80px','80px','auto','auto'],
      userClass: 'reload',
      fill: ['rgba(0,0,0,0)','images/svg-reload32.svg','0px','0px']
   }],
   symbolInstances: [
   ]
   },
...
"PREV": {
   ...
   dom: [
   {
      ...
      fill: ['rgba(0,0,0,0)','images/G-Prev32.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
...
"NEXT": {
   ...
   dom: [
   {
      ...
      rect: ['-8px','-11px','72px','98px','auto','auto'],
      clip: ['rect(-8px 79px 107px -14px)'],
      fill: ['rgba(0,0,0,0)','images/G-Next32.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
...
"musica_1": {
   ...
   dom: [
   {
      ...
      type: 'image',
      rect: ['0px','0px','80px','80px','auto','auto'],
      fill: ['rgba(0,0,0,0)','images/svg-music32.svg','0px','0px']
   }],
   symbolInstances: [
   ]
   },
...
"testina": {
   ...
   dom: [
   {
      ...
      fill: ['rgba(0,0,0,0)','images/G-Testina32.png','0px','0px']
   }],
   symbolInstances: [
   ]
   },
