...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'Q0-Counting',
            type:'image',
            rect:['590px','120px','347px','98px','auto','auto'],
         ...
         },
         {
            id:'Q0-Lets',
            type:'image',
            rect:['558px','43px','202px','73px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Q0-Lets.png",'0px','0px'],
            userClass:"letscount"
         },
         {
            id:'popuppo',
...
"RobertaName": {
   ...
   timelines: {
      "Default Timeline": {
         fromState: "Base State",
         toState: "",
         duration: 626.42222633592,
         autoPlay: false,
         timeline: [
            { id: "eid11670", tween: [ "transform", "${_Q0-NOMECopy}", "scaleY", '1.09', { fromValue: '1.09'}], position: 0, duration: 0, easing: "easeOutBounce" },
            { id: "eid11669", tween: [ "transform", "${_Q0-NOMECopy}", "scaleY", '1.09', { fromValue: '1.09'}], position: 320, duration: 223, easing: "easeOutBounce" },
