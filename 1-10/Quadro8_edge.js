...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'Q8-rocciafronde',
            type:'image',
            rect:['443px','298px','140px','139px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Q8-rocciafronde.png",'0px','0px']
         },
         {
            id:'Q8-ninfea1',
            type:'image',
            rect:['570px','397px','69px','44px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Q8-ninfea1.png",'0px','0px']
         },
         {
            id:'Q8-loto22',
            type:'image',
            rect:['634px','407px','40px','32px','auto','auto'],
            fill:["rgba(0,0,0,0)",im+"Q8-loto2.png",'0px','0px']
         },
         {
            id:'Q8-loto1',
            type:'image',
            rect:['592px','394px','42px','34px','auto','auto'],
         ...
         },
         {
            id:'giunco',
            type:'rect',
            rect:['220','161','auto','auto','auto','auto']
         },
         {
            id:'giunco3',
            type:'rect',
            rect:['126px','137px','auto','auto','auto','auto']
         },
         {
            id:'giunco2',
            type:'rect',
         ...
         },
         {
            id:'giunco4',
            type:'rect',
            rect:['44px','205px','auto','auto','auto','auto'],
            transform:[[],['-6'],[],[],['22.1862%','97.9807%']]
         },
         {
            id:'numerazio',
            type:'rect',
         ...
         },
         {
            id:'Rectangle',
            type:'rect',
            rect:['113px','253px','121px','99px','auto','auto'],
            fill:["rgba(192,192,192,1)"],
            stroke:[0,"rgba(0,0,0,1)","none"],
            userClass:"triggers"
         },
         {
            id:'FUMELLO',
            type:'rect',
            rect:['302px','-232px','auto','auto','auto','auto']
         },
         {
            id:'Menu',
            type:'rect',
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid4472", tween: [ "motion", "${_papera4}", [[112.5,625.5,0,0],[166.5,621.58,91.1,2.47,81.63,2.21],[272.5,632.58,127.56,11.31]]], position: 0, duration: 1068 },
            { id: "eid4473", tween: [ "motion", "${_papera4}", [[272.5,632.58,105.48,9.36],[367.5,617.5,101.35,5.51]]], position: 1068, duration: 815 },
            { id: "eid4474", tween: [ "motion", "${_papera4}", [[367.5,617.5,96.7,5.26],[485.5,660.42,94.9,33.06]]], position: 1883, duration: 762 },
            { id: "eid4475", tween: [ "motion", "${_papera4}", [[485.5,660.42,92.85,32.35],[593.12,627.91,85.1,-96.62,107.54,-122.09],[639.5,466.77,0,0]]], position: 2644, duration: 1856 },
            { id: "eid4494", tween: [ "style", "${_Q8-fronde2}", "top", '83px', { fromValue: '83px'}], position: 0, duration: 0 },
            ...
            { id: "eid4466", tween: [ "motion", "${_papera2}", [[367.5,617.5,96.7,5.26],[471.5,646.58,97.68,23.61]]], position: 1883, duration: 762 },
            { id: "eid4467", tween: [ "motion", "${_papera2}", [[471.5,646.58,91.69,22.16],[567.8,677.98,174.59,35.77,159.38,32.65],[674.5,685.58,0,0]]], position: 2644, duration: 1856 },
            ...
            { id: "eid4477", tween: [ "motion", "${_papera5}", [[272.5,632.58,105.48,9.36],[367.5,617.5,101.35,-36.67]]], position: 1068, duration: 815 },
            { id: "eid4478", tween: [ "motion", "${_papera5}", [[367.5,617.5,91.07,-32.95],[465.5,586.42,98.69,-29.31]]], position: 1883, duration: 762 },
            { id: "eid4479", tween: [ "motion", "${_papera5}", [[465.5,586.42,94.26,-27.99],[532.71,552.74,52.29,-65.54,29.67,-37.2],[550.5,471.58,0,0]]], position: 2644, duration: 1856 },
            ...
            { id: "eid4470", tween: [ "motion", "${_papera3}", [[367.5,617.5,96.7,5.26],[471.5,640.42,95.29,-31.92]]], position: 1883, duration: 762 },
            { id: "eid4471", tween: [ "motion", "${_papera3}", [[471.5,640.42,82.34,-27.59],[575.76,610.38,126.27,-65.93,141.1,-73.67],[667.79,536.58,0,0]]], position: 2644, duration: 1856 },
            { id: "eid4485", tween: [ "motion", "${_papera7}", [[112.5,625.5,0,0],[272.5,632.58,241.86,21.45]]], position: 0, duration: 1068 },
            { id: "eid4486", tween: [ "motion", "${_papera7}", [[272.5,632.58,105.48,9.36],[367.5,617.5,98.31,-25.23]]], position: 1068, duration: 815 },
            { id: "eid4487", tween: [ "motion", "${_papera7}", [[367.5,617.5,93.67,-24.04],[485.5,578.58,94.9,33.06]]], position: 1883, duration: 762 },
            { id: "eid4488", tween: [ "motion", "${_papera7}", [[485.5,578.58,92.85,32.35],[527.23,609.36,95.6,23.55,57.21,14.09],[592.5,617.52,0,0]]], position: 2644, duration: 1856 },
