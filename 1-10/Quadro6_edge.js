...
"stage": {
   ...
   content: {
         ...
         },
         {
            id:'resetto',
            type:'text',
            rect:['711px','673px','169px','83px','auto','auto'],
            cursor:['pointer'],
            text:"reset",
            align:"left",
            font:['Arial, Helvetica, sans-serif',74,"rgba(0,0,0,1)","normal","none","normal"]
   ...
   timelines: {
      "Default Timeline": {
         ...
         autoPlay: true,
         timeline: [
            { id: "eid3218", tween: [ "style", "${_temp6}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid3216", tween: [ "style", "${_temp4}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid3215", tween: [ "style", "${_temp3}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid3213", tween: [ "style", "${_temp1}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            { id: "eid3214", tween: [ "style", "${_temp2}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
            ...
            { id: "eid3413", tween: [ "style", "${_Mucca}", "-moz-transform-origin", [47.66,95.92], { valueTemplate: '@@0@@% @@1@@%', fromValue: [47.66,95.92]}], position: 0, duration: 0 },
            { id: "eid3414", tween: [ "style", "${_Mucca}", "-ms-transform-origin", [47.66,95.92], { valueTemplate: '@@0@@% @@1@@%', fromValue: [47.66,95.92]}], position: 0, duration: 0 },
            { id: "eid3415", tween: [ "style", "${_Mucca}", "msTransformOrigin", [47.66,95.92], { valueTemplate: '@@0@@% @@1@@%', fromValue: [47.66,95.92]}], position: 0, duration: 0 },
            { id: "eid3416", tween: [ "style", "${_Mucca}", "-o-transform-origin", [47.66,95.92], { valueTemplate: '@@0@@% @@1@@%', fromValue: [47.66,95.92]}], position: 0, duration: 0 },
            { id: "eid3190", tween: [ "style", "${_Mucca}", "top", '51px', { fromValue: '51px'}], position: 0, duration: 0 },
            { id: "eid3217", tween: [ "style", "${_temp5}", "display", 'none', { fromValue: 'none'}], position: 0, duration: 0 },
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid3163", tween: [ "transform", "${_Coda}", "rotateZ", '42deg', { fromValue: '31deg'}], position: 4458, duration: 165 },
            { id: "eid3164", tween: [ "transform", "${_Coda}", "rotateZ", '30deg', { fromValue: '42deg'}], position: 4623, duration: 150 },
            { id: "eid3165", tween: [ "transform", "${_Coda}", "rotateZ", '31deg', { fromValue: '30deg'}], position: 4773, duration: 140 },
            { id: "eid3170", tween: [ "transform", "${_Coda}", "rotateZ", '17deg', { fromValue: '31deg'}], position: 4913, duration: 96 },
            { id: "eid3171", tween: [ "transform", "${_Coda}", "rotateZ", '42deg', { fromValue: '17deg'}], position: 5009, duration: 130 },
            { id: "eid3172", tween: [ "transform", "${_Coda}", "rotateZ", '31deg', { fromValue: '42deg'}], position: 5139, duration: 70 },
            { id: "eid3337", tween: [ "transform", "${_Coda}", "rotateZ", '1deg', { fromValue: '31deg'}], position: 5815, duration: 496, easing: "easeInOutQuad" },
            { id: "eid3338", tween: [ "transform", "${_Coda}", "rotateZ", '45deg', { fromValue: '1deg'}], position: 6311, duration: 148, easing: "easeInOutQuad" },
            { id: "eid3339", tween: [ "transform", "${_Coda}", "rotateZ", '19deg', { fromValue: '45deg'}], position: 6459, duration: 175, easing: "easeInOutQuad" },
            { id: "eid3340", tween: [ "transform", "${_Coda}", "rotateZ", '44deg', { fromValue: '19deg'}], position: 6634, duration: 116, easing: "easeInOutQuad" },
            { id: "eid3341", tween: [ "transform", "${_Coda}", "rotateZ", '21deg', { fromValue: '44deg'}], position: 6750, duration: 110, easing: "easeInOutQuad" },
            { id: "eid3342", tween: [ "transform", "${_Coda}", "rotateZ", '38deg', { fromValue: '21deg'}], position: 6860, duration: 140, easing: "easeInOutQuad" },
            { id: "eid3343", tween: [ "transform", "${_Coda}", "rotateZ", '26deg', { fromValue: '38deg'}], position: 7000, duration: 118, easing: "easeInOutQuad" },
            { id: "eid3344", tween: [ "transform", "${_Coda}", "rotateZ", '43deg', { fromValue: '26deg'}], position: 7118, duration: 148, easing: "easeInOutQuad" },
            { id: "eid3345", tween: [ "transform", "${_Coda}", "rotateZ", '26deg', { fromValue: '43deg'}], position: 7266, duration: 124, easing: "easeInOutQuad" },
            { id: "eid3346", tween: [ "transform", "${_Coda}", "rotateZ", '31deg', { fromValue: '26deg'}], position: 7390, duration: 525, easing: "easeInOutQuad" },
...
"numerazio": {
   ...
   dom: [
   {
      ...
      c: [
      {
         ...
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-1.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-2',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-2.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-3',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-3.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-4',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-4.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-5',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-5.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-6',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-6.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-7',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-7.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-8',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-8.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-9',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-9.png','0px','0px']
      },
      {
         rect: ['0px','0px','350px','281px','auto','auto'],
         id: 'Num-10',
         userClass: 'numeris',
         type: 'image',
         fill: ['rgba(0,0,0,0)','images/Num-10.png','0px','0px']
      }]
   }],
   symbolInstances: [
   ]
   ...
   timelines: {
      "Default Timeline": {
         ...
         timeline: [
            ...
            { id: "eid2428", tween: [ "transform", "${_numerigruppo}", "scaleX", '1', { fromValue: '0'}], position: 0, duration: 786, easing: "swing" },
            { id: "eid2439", tween: [ "transform", "${_numerigruppo}", "scaleX", '0', { fromValue: '1'}], position: 1884, duration: 543 },
            ...
            { id: "eid2429", tween: [ "transform", "${_numerigruppo}", "scaleY", '1', { fromValue: '0'}], position: 0, duration: 786, easing: "swing" },
            { id: "eid2440", tween: [ "transform", "${_numerigruppo}", "scaleY", '0', { fromValue: '1'}], position: 1884, duration: 543 }         ]
      }
   }
}
};
